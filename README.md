...
cp /path/to/ralph/prompt.md scripts/ralph/prompt.md    # For OpenCode
cp /path/to/ralph/CLAUDE.md scripts/ralph/CLAUDE.md    # For Claude Code (if using --tool claude)
...
| `prompt.md` | Prompt template for OpenCode |
...
After copying `prompt.md` (for OpenCode) and/or `CLAUDE.md` (for Claude Code) to your project, customize them for your project:
